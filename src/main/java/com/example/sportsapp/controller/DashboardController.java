...
public class DashboardController {
    ...
    public String showDashboard(
        ...
        Page<Players> playerPageData = playerService.getAllPlayersPaginated(playerPageable);
...
//        model.addAttribute("users", users);
    ...
    public String showPlayersDashboard(
        ...
        Page<Players> playerPage = playerService.getAllPlayersPaginated(pageable); // Use Pageable in your service
